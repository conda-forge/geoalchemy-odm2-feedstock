About geoalchemy-odm2-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/geoalchemy-odm2-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3917&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/geoalchemy-odm2-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `geoalchemy-odm2` can be installed with `conda`:
...
```
mamba install geoalchemy-odm2
```

It is possible to list all of the versions of `geoalchemy-odm2` available on your platform with `conda`:
...
```
mamba search geoalchemy-odm2 --channel conda-forge
```
...
mamba repoquery search geoalchemy-odm2 --channel conda-forge

# List packages depending on `geoalchemy-odm2`:
mamba repoquery whoneeds geoalchemy-odm2 --channel conda-forge

# List dependencies of `geoalchemy-odm2`:
mamba repoquery depends geoalchemy-odm2 --channel conda-forge
```
